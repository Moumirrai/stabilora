...
import { AddNodeOperation } from './AddNodeOperation';
...
describe('AddNodeOperation', () => {
  ...
  it('should add a node with specified name when do() is called', () => {
    const command = new AddNodeOperation(10, 20, 5);
  ...
  it('should autoincrement largest node name when creating new one', () => {
    ...
    const command = new AddNodeOperation(30, 40); // no name provided
  ...
  it('should remove the added node when undo() is called', () => {
    const command = new AddNodeOperation(10, 20, 1);
  ...
  it('should remove the correct node when undo() is called with multiple nodes present', () => {
    ...
    const command = new AddNodeOperation(50, 60, 2); // command for the second node
