...
const initDebugModel = (): Model => {
  const nodes: Node[] = [
    {
      ...
      dx: -6000,
      dy: 0,
      constraint: { fixedX: true, fixedY: true, fixedRotation: true },
    }, //0
    { id: crypto.randomUUID(), name: 2, dx: -2000, dy: 0 }, //1
    { id: crypto.randomUUID(), name: 3, dx: 2000, dy: 0 }, //2
    {
      id: crypto.randomUUID(),
      name: 4,
      dx: 6000,
      dy: 0,
      constraint: { fixedX: true, fixedY: true },
    }, //3
    { id: crypto.randomUUID(), name: 5, dx: 4000, dy: -3000 }, //4
    { id: crypto.randomUUID(), name: 5, dx: 0, dy: -3000 }, //5
    {
      id: crypto.randomUUID(),
      name: 5,
      dx: -4000,
  ...
  const elements: Element[] = [
    { id: crypto.randomUUID(), nodeA: nodes[0], nodeB: nodes[1] },
    { id: crypto.randomUUID(), nodeA: nodes[1], nodeB: nodes[2] },
    { id: crypto.randomUUID(), nodeA: nodes[2], nodeB: nodes[3] },
    { id: crypto.randomUUID(), nodeA: nodes[3], nodeB: nodes[4] },
    { id: crypto.randomUUID(), nodeA: nodes[4], nodeB: nodes[5] },
    { id: crypto.randomUUID(), nodeA: nodes[5], nodeB: nodes[6] },
    { id: crypto.randomUUID(), nodeA: nodes[6], nodeB: nodes[0] },
    { id: crypto.randomUUID(), nodeA: nodes[1], nodeB: nodes[6] },
    { id: crypto.randomUUID(), nodeA: nodes[1], nodeB: nodes[5] },
    { id: crypto.randomUUID(), nodeA: nodes[2], nodeB: nodes[5] },
    { id: crypto.randomUUID(), nodeA: nodes[2], nodeB: nodes[4] },
  ];
